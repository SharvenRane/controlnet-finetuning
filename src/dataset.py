...
class ControlnetFinetuningDataset(Dataset):
    """Dataset for controlnet finetuning."""
...
def get_dataloader(root, split, config):
    ...
    dataset = ControlnetFinetuningDataset(root, split, transform)
    return DataLoader(
        dataset,
